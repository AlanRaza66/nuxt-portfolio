...
<template>
  <main class="w-full min-h-screen">
    ...
    <div
      class="h-screen w-full bg-primary pt-[96px] pb-[1rem] px-[1rem] md:h-screen md:pt-[56px] md:pb-[0.75rem] md:px-[0.75rem] relative"
    >
      <HeroHome />
    </div>
    <div
    ...
    <div
      class="h-fit w-full bg-primary p-[1rem] pt-0 px-[1rem] md:px-[0.75rem] md:pb-[0.75rem] md:h-auto relative"
    >
      <FooterHome />
    </div>
  </main>
